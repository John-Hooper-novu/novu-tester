(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("novuTester", [], factory);
	else if(typeof exports === 'object')
		exports["novuTester"] = factory();
	else
		root["novuTester"] = factory();
...
exports.log = exports.components = exports.tester = undefined;

var _tester = __webpack_require__(2);
...
function importComp(component) {
	...
	Object.assign(components, __webpack_require__(3)("./" + component + '/index.js').default);
}
importComp('buttons');
importComp('input');
...
var log = function log() {
	return console.log('logging from bundle');
};
...
var buttonLog = function buttonLog() {
  return console.log('logged a button');
};
exports.default = buttonLog;
...
var inputLog = function inputLog() {
  return console.log('log from input');
};

exports.default = { inputLog: inputLog };
